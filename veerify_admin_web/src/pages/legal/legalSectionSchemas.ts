// veerify_admin_web/src/pages/legal/legalSectionSchemas.ts
//
// Mirror of backend/src/utils/legalSectionSchemas.js — the outline for
// every legal / policy slug the platform manages. Keep these two files
// in sync when you add or rename a section.
...
export const PLATFORM_SECTIONS: Record<string, SectionSchema[]> = {
...
export const INSTITUTION_SECTIONS: Record<string, SectionSchema[]> = {
  about_academy: [
...
export function sectionsForSlug(slug: string): SectionSchema[] {
