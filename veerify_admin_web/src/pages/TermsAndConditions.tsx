...
export default function TermsAndConditions() {
  ...
  useEffect(() => {
    (async () => {
      try {
        setLoading(true);
        const res = await publicClient.get('/legal-pages/public/terms_and_conditions');
        setPage(res.data?.page || null);
      } catch {
        setError('Unable to load the Terms & Conditions. Please try again later.');
      } finally {
        setLoading(false);
      }
    })();
  ...
  return (
    <main className="min-h-screen bg-[#080C1A] text-white">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-1/3 w-[400px] h-[400px] rounded-full bg-sky-600/8 blur-[80px]" />
      </div>
      ...
      <header className="relative z-20 border-b border-white/5 bg-white/3 backdrop-blur-xl">
        <div className="max-w-5xl mx-auto px-5 py-4 flex items-center gap-3">
          ...
          <div>
            <p className="text-xs font-semibold text-blue-400 uppercase tracking-widest">Veerify Platform</p>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-5 py-14">
        ...
        <div className="mb-14 text-center">
          <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-5 py-2 text-sm text-blue-300 font-medium mb-6 backdrop-blur-sm">
            <FileText size={15} />
            Legal &amp; Terms
          </div>
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto leading-relaxed">
            By accessing or using Veerify, you agree to be bound by these terms and conditions.
          </p>
          {page?.updated_at && (
        ...
        {!loading && !error && (!page || !page.sections?.length) && (
          <div className="flex flex-col items-center justify-center py-20 gap-3">
            ...
            <p className="text-gray-500">Terms &amp; Conditions content hasn't been published yet.</p>
          </div>
        )}
          ...
          <div className="space-y-6">
            {page.sections
              ...
              .map((section, idx) => (
                <div
                  key={section.key}
                  className="group relative bg-white/4 backdrop-blur-md border border-white/8 rounded-2xl p-7 hover:bg-white/6 hover:border-blue-500/20 transition-all duration-300"
                >
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-4">
                      <span className="w-7 h-7 rounded-lg bg-blue-500/15 border border-blue-500/20 flex items-center justify-center text-xs font-black text-blue-400">
                        {idx + 1}
                      </span>
      ...
      <footer className="relative z-10 border-t border-white/5 mt-20">
        <div className="max-w-5xl mx-auto px-5 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-5 text-xs text-gray-600">
            ...
            <a href="/terms-and-conditions" className="hover:text-blue-400 transition-colors font-medium text-blue-400">
              Terms &amp; Conditions
            </a>
            <a href="/refund-cancellation-policy" className="hover:text-blue-400 transition-colors">
              Refund Policy
            </a>
          </div>
        </div>
      ...
      <style>{`
        ...
        .prose-legal a { color: #60a5fa; text-decoration: underline; }
